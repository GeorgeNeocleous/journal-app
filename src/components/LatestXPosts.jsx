...
export default function LatestXPosts({limit}){
    ...
    // The idea is that when there are changes to journalEntries, the PostList should re-render through use-effects
    ...
    useEffect(() => {
        ...
        // This is where the posts are sorted for rendering
